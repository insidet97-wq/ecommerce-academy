...
| `created_at` | timestamptz | Used for tier rate-limiting (Pro 5/day, Growth 50/day per tool) and the future Vault feature |
...
GROQ_API_KEY=gsk_...                  # primary, free tier (currently used for everything)
OPENAI_API_KEY=sk-...                 # optional fallback / future Pro upgrade
ANTHROPIC_API_KEY=sk-ant-...          # optional fallback / future Scale Lab Claude upgrade
