...
<head>
  ...
  <title>Welcome to Ecommerce Academy</title>
</head>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f8;padding:40px 20px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <!-- Header -->
        <tr><td style="background:linear-gradient(135deg,#1e1b4b 0%,#312e81 40%,#4c1d95 100%);border-radius:20px 20px 0 0;padding:40px 40px 36px;text-align:center;">
          ...
          <p style="margin:0 0 20px;font-size:22px;font-weight:800;color:#fff;letter-spacing:-0.5px;">Ecommerce Academy</p>
